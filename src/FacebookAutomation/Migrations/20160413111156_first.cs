...
namespace FacebookAutomation.Migrations
{
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrixVente = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    idProduit = table.Column<string>(nullable: true),
                    idUtilisateur = table.Column<string>(nullable: true),
                    log = table.Column<string>(nullable: true),
                    numerotransaction = table.Column<string>(nullable: true),
                    produitId = table.Column<string>(nullable: true),
                    status = table.Column<string>(nullable: true),
                    statuscinetpay = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable("Produits");
            migrationBuilder.AlterColumn<string>(
                name: "UserId",
                table: "AspNetUserLogins",
                nullable: true);
